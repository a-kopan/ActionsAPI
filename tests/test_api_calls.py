...
class TestApiCalls(unittest.TestCase):
    ...
    def test_single_date(self):
        ...
        self.assertEqual(
            response, response_single_date, "Single company and single date test."
        )
    ...
    def test_single_range(self):
        ...
        response = json.loads(requests.get(url).text)
        self.assertEqual(
            response, response_single_range, "Single company and date range test."
        )
    ...
    def test_multi_date(self):
        ...
        response = json.loads(requests.get(url).text)
        self.assertEqual(
            response, response_multi_date, "Multiple companies and single date test."
        )
    ...
    def test_multi_range(self):
        ...
        response = json.loads(requests.get(url).text)
        self.assertEqual(
            response, response_multi_range, "Multiple companies and date range test."
        )
    ...
    def test_multi_both(self):
        url = (
            base_url
            + "Meta&Netflix?date=2021-12-06&date_s=2021-12-06&date_e=2022-12-06"
        )
        response = json.loads(requests.get(url).text)
        self.assertEqual(
            response,
            response_multi_both,
            "Multiple companies and both date and date range test.",
        )

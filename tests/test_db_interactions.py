...
class TestDatabaseQueries(unittest.TestCase):
    ...
    def test_date_single(self):
        ...
        self.assertEqual(
            records, response_date_single, msg="Single company and date test."
        )
    ...
    def test_range_single(self):
        ...
        self.assertEqual(
            records, response_range_single, msg="Single company and date range test."
        )
    ...
    def test_date_multiple(self):
        ...
        records = get_records(data, db_path, True)
        self.assertEqual(
            records, response_date_multiple, msg="Single company and date test."
        )
    ...
    def test_range_multiple(self):
        ...
        self.assertEqual(
            ...
            msg="Multiple companies and date range test.",
        )
